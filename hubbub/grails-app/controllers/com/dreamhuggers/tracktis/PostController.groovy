...
import com.dreamhuggers.tracktis.User
import com.dreamhuggers.tracktis.PostException
...
class PostController {
    ...
    static navigation = [
        [group: 'tabs', action: 'personal', title: 'My Posts', order: 0, isVisible: {authenticateService.userDomain() != null}],
        [action:'timeline', title: 'My Timeline', order: 1, isVisible: {authenticateService.userDomain() != null}],
